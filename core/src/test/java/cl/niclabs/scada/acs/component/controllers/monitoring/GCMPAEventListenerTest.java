 ...
 *
 */
public class GCMPAEventListenerTest extends AbstractComponentTest {

    // Special monitor notifier for testing purposes
    interface TestingMonitorNotifier extends RecordEventListener {
        long getCheckNumber();
    }
        ...
        TestingMonitorNotifier monitorNotifier = new TestingMonitorNotifier() {
            ...
            public void notifyACSEvent(RecordEvent eventType) {
                switch (eventType) {
                    ...
                    case FUTURE_RECEIVED: checkNumber.addAndGet(10000); break;
                    case RESPONSE_RECEIVED: checkNumber.addAndGet(100000); break;
