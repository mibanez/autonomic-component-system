...
public class ACSAdlBasicFactory extends PABasicFactory implements ACSAdlFactory {
	...
	public Object newACSComponent(String name, Map context) throws Exception {
        ...
        addACSControllers(component, new BuildHelper(new cl.niclabs.scada.acs.component.factory.ACSFactory()));
		return component;
	}
