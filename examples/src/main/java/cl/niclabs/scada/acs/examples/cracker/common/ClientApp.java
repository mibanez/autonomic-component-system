...
public class ClientApp {
    ...
    private static final String CLIENT_ADL = "cl.niclabs.scada.acs.examples.cracker.common.components.Client";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Component clientComp = (Component) adlFactory.newACSComponent(CLIENT_ADL, null);
