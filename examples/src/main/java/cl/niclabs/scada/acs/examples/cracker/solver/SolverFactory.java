...
import cl.niclabs.scada.acs.examples.cracker.solver.component.*;
...
public class SolverFactory {
    ...
    public Component getSolver(String name, int numberOfWorkers, Node node) throws ACSFactoryException,
        ...
        for (int i = 0; i < numberOfWorkers; i++) {
            ...
            masterBindingController.bindFc(SlaveMulticast.NAME, slave.getFcInterface(Slave.NAME));
        }
    ...
    private ComponentType getMasterType() throws ACSFactoryException {
        return factory.createComponentType(new InterfaceType[]{
                ...
                factory.createInterfaceType(SlaveMulticast.NAME, SlaveMulticast.class, true, false, "multicast")
        });
    }
